...
$form.Text = "Kimi Activity Extraction"
...
$command = "& '$pythonPath' -m pd_extractor.activities.cli extract --database '$databasePath' --work '$workPath' --limit 200; Write-Host ''; Read-Host 'Finished. Press Enter to close'"
