...
$form.Text = "Kimi Activity Vocabulary"
...
$command = "Remove-Item -LiteralPath '$workPath\2_vocabulary.json' -ErrorAction SilentlyContinue; Remove-Item -LiteralPath '$workPath\2_cluster_members.json' -ErrorAction SilentlyContinue; Remove-Item -LiteralPath '$workPath\3_assigned.jsonl' -ErrorAction SilentlyContinue; & '$pythonPath' -m pd_extractor.activities.cli vocab --database '$databasePath' --work '$workPath' --min-count 1; Write-Host ''; Read-Host 'Finished. Press Enter to close'"
